...
# -*- coding: utf-8 -*-
#
# kaybee_theme documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'kaybee_theme.tex', 'kaybee\\_theme Documentation',
     'Paul Everitt', 'manual'),
]
